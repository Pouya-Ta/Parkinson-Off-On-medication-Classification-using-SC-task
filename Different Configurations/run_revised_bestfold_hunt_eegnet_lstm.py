...
def main():
    ...
    for cfg in SEARCH_SPACE:
        ...
        fold_best_df, epoch_history_df, summary_row = run_one_config(X, y, subject_ids, cfg)
    ...
    summary_df = pd.DataFrame(all_summary_rows).sort_values(
        by=["best_fold_balanced_accuracy", "mean_balanced_accuracy"],
        ascending=False
