...
# Configuration
# =========================
DATA_DIR = Path("/Users/pouya/Documents/Additional Academic Activities/MA/SC OFF:ON/My Codes/Revised/revised_channel_subset_datasets")
OUTPUT_DIR = Path("/Users/pouya/Documents/Additional Academic Activities/MA/SC OFF:ON/My Codes/Revised/revised_channel_subset_results")
OUTPUT_DIR.mkdir(exist_ok=True, parents=True)

#DATASET_NAME = "PD_ON_vs_PD_OFF_subset_motor_related"
#DATASET_NAME = "PD_ON_vs_PD_OFF_subset_all_channels"
#DATASET_NAME = "PD_ON_vs_PD_OFF_subset_fronto_central"
DATASET_NAME = "PD_ON_vs_PD_OFF_subset_midline"
...
class EEGNetLSTM(nn.Module):
    def __init__(
        ...
        # اگر پنجره زمانی کوتاه شد، کرنل را بیش از حد بزرگ نگذار
        kernel_length = min(kernel_length, max(8, n_times // 2))
